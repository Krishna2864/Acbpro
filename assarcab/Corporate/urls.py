...
router.register(r'vehiclemanagement', views.VehicleManagementViewset)
router.register(r'drivermanagement', views.DriverManagementViewset)
router.register(r'countrymanagement', views.CountryManagementViewset)
router.register(r'statemanagement', views.StateManagementViewset)
router.register(r'citymanagement', views.CityManagementViewset)
router.register(r'advertisementmanagement', views.AdvertisementManagementViewset)
# router.register(r'refralmanagement', views.)
router.register(r'fuelmanagement', views.FuelManagementViewset)
router.register(r'maintainancemanagement', views.MaintainanceManagementViewset)
router.register(r'routemanagement', views.RouteViewset)
router.register(r'faremanagement', views.FareManagementViewset)
router.register(r'outstation', views.OutstationViewset)
router.register(r'local', views.LocalViewset)
router.register(r'pickuppoint', views.PickupPointViewset)
router.register(r'dropuppoint', views.DropupPointViewset)
router.register(r'listingassign', views.ListingAssignManagementViewset)
...
router.register(r'termscondition', views.TermsConditionViewset)
router.register(r'privacypolicy', views.PrivacyPolicyViewset)
router.register(r'template', views.TemplatesManagementViewset)
router.register(r'employee', views.EmployeeTaxiViewset)
router.register(r'employeetransportation', views.EmployeeTransportationViewset)
router.register(r'outstationsecond', views.OutstationSecondViewset)
router.register(r'localsecond', views.LocalSecondViewset)
