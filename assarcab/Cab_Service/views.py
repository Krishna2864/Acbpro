...
from .models import Admin_Management, User_Management, Vehicle_Management, Driver_Mangement, Country_Management, \
    ...
    Maintenance_Management, Route_Management, Fare_Management, TIME_SCHEDULE_MGMT, Pickup_Point_Management, \
    DROPUp_Point_Management, Listing_ASSIGN_Management, Co_partner_Management, Notification_to_Ridder, Notification_to_Driver, \
    Consignment_Tracking, Transaction_Management, LIST_YOUR_VEHICLE_MGMT, Feedback, Seat_Mangement, SOS, Support_HELP, \
...
from .serializers import Admin_ManagementSerailizer, User_ManagementSerailizer, Vehicle_ManagementSerailizer, \
    ...
    Maintenance_ManagementSerailizer, Route_ManagementSerailizer, Fare_ManagementSerailizer, TIME_SCHEDULE_MGMTSerailizer, \
    Pickup_Point_ManagementSerailizer, DROPUp_Point_ManagementSerailizer, Listing_ASSIGN_ManagementSerailizer, \
    Consignment_TrackingSerailizer, Co_partner_ManagementSerailizer, Notification_to_RidderSerailizer, Notification_to_DriverSerailizer, \
    Transaction_ManagementSerailizer, LIST_YOUR_VEHICLE_MGMTSerailizer, FeedbackSerailizer, Seat_MangementSerailizer, \
    SOSSerailizer, Support_HELPSerailizer, TERMS_CONDITIONSSerailizer, PRIVACY_POLICYSerailizer
