...
router.register(r'vehiclemanagement', views.VehicalManagementViewset)
#Todo Aayushi Change the URL name for rest
router.register(r'snippets', views.DriverManagementViewset)
...
router.register(r'snippets', views.RouteViewset)
router.register(r'snippets', views.FareManagementViewset)
router.register(r'snippets', views.TimeScheduleViewset)
router.register(r'snippets', views.PickupPointViewset)
router.register(r'snippets', views.DropUpPointViewset)
router.register(r'snippets', views.ListingAssignViewset)
router.register(r'snippets', views.CoPartnerManagementViewset)
...
urlpatterns=[
path('cabservice', include(router.urls)),
