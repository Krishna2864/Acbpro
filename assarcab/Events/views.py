...
State_Management, City_Management, Advertisement_Management, Refral_Mangemnt, Refund_Management, Fuel_Mangement, \
    Maintenance_Management, LIST_YOUR_VEHICLE_MGMT, Feedback, Seat_Mangement, SOS, Support_HELP, TERMS_CONDITIONS, PRIVACY_POLICY,\
Route_Management, Fare_Management, Fare_Management_Outstation, Fare_Management_Local, TIME_SCHEDULE_MGMT, \
Pickup_Point_Management, DROPUp_Point_Management, Listing_ASSIGN_Management, Co_partner_Management, Notification_to_Ridder, Notification_to_Driver, Consignment_Tracking, \
...
Driver_MangementSerailizer, Country_ManagementSerailizer, State_ManagementSerailizer, City_ManagementSerailizer, \
    Advertisement_ManagementSerailizer, Refral_MangemntSerailizer, Refund_ManagementSerailizer, Fuel_MangementSerailizer, \
Maintenance_ManagementSerailizer, Route_ManagementSerailizer, Fare_ManagementSerailizer, Fare_ManagementOutStationSerailizer, \
Fare_ManagementLocalSerailizer, TIME_SCHEDULE_MGMTSerailizer, Pickup_Point_ManagementSerailizer, DROPUp_Point_ManagementSerailizer, \
Listing_ASSIGN_ManagementSerailizer, Co_partner_ManagementSerailizer, Notification_to_RidderSerailizer, Notification_to_DriverSerailizer, \
Consignment_TrackingSerailizer, Transaction_ManagementSerailizer, LIST_YOUR_VEHICLE_MGMTSerailizer, FeedbackSerailizer, Seat_MangementSerailizer, SOSSerailizer, \
Support_HELPSerailizer, TERMS_CONDITIONSSerailizer, PRIVACY_POLICYSerailizer
...
class RouteManagementViewset(viewsets.ModelViewSet):
...
class FareLocalStationViewset(viewsets.ModelViewSet):
...
class PickupPointManagementViewset(viewsets.ModelViewSet):
    queryset = Pickup_Point_Management.objects.all()
    serializer_class = Pickup_Point_ManagementSerailizer

class DropupPointManagementViewset(viewsets.ModelViewSet):
    queryset = DROPUp_Point_Management.objects.all()
    serializer_class = DROPUp_Point_ManagementSerailizer

class ListinAssignManagementViewset(viewsets.ModelViewSet):
...
class SeatManagementViewset(viewsets.ModelViewSet):
    queryset = Seat_Mangement.objects.all()
