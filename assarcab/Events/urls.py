...
router.register(r'adminmanagement', views.AdminManagementViewset)
router.register(r'usermanagement', views.UserManagementViewset)
router.register(r'vehicalmanagement', views.VehicalManagementViewset)
router.register(r'drivermanagement', views.DriverManagementViewset)
# Todo Aayushi Change the URL name for rest
router.register(r'snippets', views.CountryManagementViewset)
router.register(r'snippets', views.StateManagementViewset)
router.register(r'snippets', views.CityManagementViewset)
router.register(r'snippets', views.AdvertisementManagementViewset)
router.register(r'snippets', views.RefralManagementViewset)
router.register(r'snippets', views.RefundManagementViewset)
router.register(r'snippets', views.FuelManagementViewset)
router.register(r'snippets', views.MaintainanceManagementViewset)
router.register(r'snippets', views.FareManagementViewset)
router.register(r'snippets', views.RouteManagementViewset)
router.register(r'snippets', views.FareOutStationViewset)
router.register(r'snippets', views.FareLocalStationViewset)
router.register(r'snippets', views.TimeScheduleManagementViewset)
router.register(r'snippets', views.PickupPointManagementViewset)
router.register(r'snippets', views.DropupPointManagementViewset)
router.register(r'snippets', views.ListinAssignManagementViewset)
router.register(r'snippets', views.CoPartnerViewset)
router.register(r'snippets', views.NotificationToRiderViewset)
router.register(r'snippets', views.NotificationToDriverViewset)
router.register(r'snippets', views.ConsignmentTrackingViewset)
router.register(r'snippets', views.TransactionManagementViewset)
router.register(r'snippets', views.ListYourVehicleViewset)
router.register(r'snippets', views.FeedbackViewset)
router.register(r'snippets', views.SeatManagementViewset)
router.register(r'snippets', views.SOSViewset)
router.register(r'snippets', views.SupportHelpViewset)
router.register(r'snippets', views.TermsConditionViewset)
router.register(r'snippets', views.PrivacyPolicyViewset)
