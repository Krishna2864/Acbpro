...
router.register(r'snippets', views.NotificationToCoPartnerViewset)
router.register(r'snippets', views.NotificationToUserViewset)
router.register(r'snippets', views.ContentManagementViewset)
router.register(r'snippets', views.TransactionManagementViewset)
router.register(r'snippets', views.VehicleMonitoringViewset)
router.register(r'snippets', views.FeedbackViewset)
router.register(r'snippets', views.SOSViewset)
router.register(r'snippets', views.SupportViewset)
router.register(r'snippets', views.TermsConditionViewset)
router.register(r'snippets', views.PrivacyPolicyViewset)
router.register(r'snippets', views.ListingManagementViewset)
router.register(r'snippets', views.YourVehicleManagementViewset)


urlpatterns=[

    path('selfdrive', include(router.urls)),
#1
