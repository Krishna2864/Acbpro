...
router.register(r'vehicle', views.VehicleManagementViewset)
router.register(r'vehiclemonitering', views.vehicle_MoniteringViewset)
router.register(r'listing', views.ListingAssignViewset)
