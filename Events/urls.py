...
#router.register(r'fareoutstations', views.Fare_Management_OutstationViewset)
router.register(r'fare', views.Fare_ManagementViewset)
...
router.register(r'transacction', views.TransactionManagementViewset)
