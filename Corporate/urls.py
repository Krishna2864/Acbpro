...
router.register(r'fareoutstation', views.Fare_Management_OutstationViewset)
router.register(r'farelocal', views.Fare_Management_LocalViewset)
#router.register(r'fareemployetransportation', views.Fare_Management_Employee_TransportationViewset)
#router.register(r'fareemployetaxi', views.Fare_Management_Emplyee_TaxiViewset)
...
router.register(r'templates', views.TemplatesManagementViewset)
