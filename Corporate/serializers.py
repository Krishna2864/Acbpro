...
class Fare_Management_LocalSerailizer(serializers.ModelSerializer):
    class Meta:
        model=Fare_Management_Local
        fields=('__all__')

class Fare_Management_OutstationSerailizer(serializers.ModelSerializer):
    class Meta:
        model=Fare_Management_Outstation
        fields=('__all__')

class Fare_Management_Employee_TransportationSerailizer(serializers.ModelSerializer):
    class Meta:
        model=Fare_Management_Employee_Transportation
        fields=('__all__')


class Fare_Management_Emplyee_TaxiSerailizer(serializers.ModelSerializer):
    class Meta:
        model=Fare_Management_Emplyee_Taxi
        fields=('__all__')
'''
...
class Drop_PointsSerailizer(serializers.ModelSerializer):
    class Meta:
        model=Drop_Points
        fields=('__all__')
