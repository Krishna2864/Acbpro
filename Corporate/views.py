...
class Fare_Management_LocalViewset(viewsets.ModelViewSet):
    queryset = Fare_Management_Local.objects.all()
    serializer_class = Fare_Management_LocalSerailizer


class Fare_Management_Employee_TransportationViewset(viewsets.ModelViewSet):
    queryset = Fare_Management_Employee_Transportation.objects.all()
    serializer_class = Fare_Management_Employee_TransportationSerailizer


class Fare_Management_Emplyee_TaxiViewset(viewsets.ModelViewSet):
    queryset = Fare_Management_Emplyee_Taxi.objects.all()
    serializer_class = Fare_Management_Emplyee_TaxiSerailizer
'''
...
class DropUpPointViewset(viewsets.ModelViewSet):
    queryset = Drop_Points.objects.all()
    serializer_class = Drop_PointsSerailizer
